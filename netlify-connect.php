<?php
/**
 * Plugin Name: BirdBrain Netlify Connect
...
final class Littlebot_Netlify {
	...
	public function init() {
		...
		load_plugin_textdomain( 'netlify-connect', false, dirname( $this->basename ) . '/languages/' );
	...
	public function requirements_not_met_notice() {
		...
		$default_message = sprintf( __( 'Netlify is missing requirements and has been <a href="%s">deactivated</a>. Please make sure all requirements are available.', 'netlify-connect' ), admin_url( 'plugins.php' ) );
